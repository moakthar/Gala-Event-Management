...
const Profile = () => {
  ...
  const onSubmit = async (data) => {
    toast.success("Profile updated successfully!"); // Simulate profile update
  };
  ...
  const passwordSubmit = async (e) => {
    ...
    if (password === confirmPassword) {
      toast.success("Password updated successfully!"); // Simulate password update
    } else {
  ...
  const coverImageChange = async (e) => {
    e.preventDefault();
    const imageurl = URL.createObjectURL(e.target.files[0]); // Simulate image upload
    if (imageurl) {
      toast.success("Cover image updated successfully!"); // Simulate cover image update
  ...
  const profileImageChange = async (e) => {
    ...
    const imageurl = URL.createObjectURL(e.target.files[0]); // Simulate image upload
    if (imageurl) {
      toast.success("Profile image updated successfully!"); // Simulate profile image update
